...
public class EmployeePayrollServiceTest {
    ...
    void given3EmployeesWhenWrittenToFileShouldMatchEmployeeEntries() throws IOException {
        EmployeePayrollData employeePayrollData1 = new EmployeePayrollData(1,"Surabhi", 50000);
        EmployeePayrollData employeePayrollData2 = new EmployeePayrollData(2,"Sheetal", 30000);
        EmployeePayrollData employeePayrollData3 = new EmployeePayrollData(3,"Sonal", 40000);
